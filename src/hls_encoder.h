...
//                    transcode_video(_input_stream_context_1, _output_stream_context_2, video_input_packet.get(), video_input_frame_2.get() );
                        transcode_video( video_input_packet.get(), video_input_frame.get(), _scaling_frames );
                    }
                }
                else
                {
...
public:
    ...
    int encode_video( const std::unique_ptr< output_stream>& _video_stream, AVFrame *input_frame, int _stream_index ) {
